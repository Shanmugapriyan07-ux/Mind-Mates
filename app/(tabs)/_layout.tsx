...
const t = StyleSheet.create({
  outerWrapper:  { position: 'absolute', bottom: BOTTOM_OFFSET, left: 24, right: 24, shadowColor: '#8d8d8d', shadowOffset: { width: 20, height: 8 }, shadowOpacity: 1, shadowRadius: 5, elevation: 5, borderRadius: 50, marginBottom: 25, overflow: 'hidden', backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: 'rgba(255,255,255,0.6)', zIndex: 1 },
