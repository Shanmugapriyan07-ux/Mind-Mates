...
import {logout as signOut,deleteAccount, logout} from "@/services/authServices";
      ...
      <Pressable style={h.card} onPress={(e) => e.stopPropagation()}>
        <View style={h.headerRow}>
          ...
          <TouchableOpacity
            ...
            style={h.closeBtn}
          >
            <Ionicons name="close" size={20} color="#6D4AFF" />
          </TouchableOpacity>
        </View>
        ...
        <View style={h.contactBox}>
          ...
          <View style={h.btnRow}>
            <TouchableOpacity
              ...
              activeOpacity={0.85}
            >
              <Ionicons name="call" size={26} color="#fff" style={{ top: 3 }} />
        ...
        <TouchableOpacity
          ...
          activeOpacity={0.75}
        >
          <Ionicons name="mail" size={17} color="#6D4AFF" style={{ top: 1 }} />
...
export default function SettingsScreen() {
  ...
  const rows = [
    {
      icon: <Ionicons name="person-outline" size={24} color={T.icon} />,
      label: "Edit Profile",
      sub: "Name, bio, location, skills",
      onPress: () => router.push("/subScreens/editProfile"),
    },
    {
      icon: <Ionicons name="help-circle-outline" size={24} color={T.icon} />,
      label: "Help & Support",
    ...
    {
      icon: (
        <Ionicons name="shield-checkmark-outline" size={24} color={T.icon} />
      ),
    ...
    {
      icon: <Ionicons name="document-text-outline" size={24} color={T.icon} />,
    ...
    <SafeAreaView style={s.safe}>
      ...
      <Portal>
        ...
        >
          ...
          <Dialog.Content>
            <Text style={s.dialogText}>Are you sure you want to logout?</Text>
          </Dialog.Content>
      ...
      <Portal>
        ...
        >
          ...
          <Dialog.Title style={[s.dialogTitle, { color: "#EF4444" }]}>
            Delete Account?
          </Dialog.Title>
          <Dialog.Content>
            ...
            <Text style={[s.dialogText, { marginTop: 12 }]}>
...
const s = StyleSheet.create({
  ...
  version: { textAlign: "center", fontSize: 12, top: 240,color: "#6D4AFF" },
  ...
  dialogBtn: { flex: 1, marginHorizontal: 4, color: "#cac7c7" },
});
