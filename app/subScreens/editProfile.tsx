        ...
        >
          ...
          <View style={st.inputGroup}>
            ...
            <View
              style={[
                st.inputWrapper,
                focused === "fullName" && st.inputFocused,
              ]}
            >
              <Ionicons
                name="person"
          ...
          <View style={st.inputGroup}>
            ...
            <View
              style={[
                st.inputWrapper,
                focused === "InterestedSkills" && st.inputFocused,
              ]}
            >
              <Ionicons
                name="happy"
          ...
          <View style={st.inputGroup}>
            ...
            <View
              style={[
                st.inputWrapper,
                focused === "location" && st.inputFocused,
              ]}
            >
              <Ionicons
                name="location"
          ...
          <View style={st.inputGroup}>
            ...
            <View
              style={[st.textAreaWrapper, focused === "bio" && st.inputFocused]}
            >
              <TextInput
                style={st.textArea}
