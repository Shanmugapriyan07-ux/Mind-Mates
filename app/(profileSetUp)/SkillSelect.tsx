...
const SKILLS: Skill[] = [
  ...
  { id: 5, name: "Acting", category: "Passion", icon: "film-outline" },
  ...
  { id: 40, name: "Dancing", category: "Passion", icon: "body-outline" },
  ...
  { id: 46, name: "Travel", category: "Lifestyle", icon: "airplane-outline" },
  {
    id: 52,
  ...
  { id: 150, name: "Poetry", category: "Passion", icon: "fitness-outline" },
  { id: 152, name: "Theatre", category: "Passion", icon: "megaphone-outline" },
  {
    id: 154,
  ...
  {
    id: 161,
    name: "PC/Console Gaming",
    category: "Fun",
    icon: "game-controller-outline",
  },
  { id: 162, name: "Board Games", category: "Fun", icon: "grid-outline" },
  {
    id: 10,
  ...
  { id: 18, name: "Powerlifting", category: "Sports", icon: "barbell-outline" },
  ...
  { id: 185, name: "IoT", category: "Tech", icon: "wifi-outline" },
  {
    id: 186,
  ...
  { id: 190, name: "Product Design", category: "Design", icon: "cube-outline" },
  {
    id: 192,
    name: "Architecture",
    category: "Design",
  ...
  { id: 193, name: "Video Editing", category: "Design", icon: "cut-outline" },
  ...
  { id: 240, name: "Books Reading", category: "Learning", icon: "book-outline" },
  {
    id: 241,
