    ...
    <SafeAreaView style={s.safe} edges={["top"]}>
      ...
      */}
      ...
      >
          ...
          <View style={{ alignSelf: "center", width: "100%", maxWidth: contentMaxWidth }}>
            ...
            <View style={s.inputGroup}>
              ...
              <View style={[s.inputWrapper, focused === "fullName" && s.inputFocused]}>
                <Ionicons name="person" size={18} color="#6D4AFF" style={s.icon} />
                <TextInput
                  style={s.input}
            ...
            <View style={s.inputGroup}>
              ...
              <View style={[s.inputWrapper, focused === "InterestedSkills" && s.inputFocused]}>
                <Ionicons name="happy" size={18} color="#6D4AFF" style={s.icon} />
                <TextInput
                  style={s.input}
            ...
            <View style={s.inputGroup}>
              ...
              <View style={[s.inputWrapper, focused === "location" && s.inputFocused]}>
                <Ionicons name="location" size={18} color="#6D4AFF" style={s.icon} />
                <View style={{ flex: 1 }}>
                  <LocationPicker
        ...
        <View style={[s.buttonContainer, { paddingBottom: insets.bottom + SPACING.md }]}>
