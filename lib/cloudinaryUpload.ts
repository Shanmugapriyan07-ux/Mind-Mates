...
// // Production Cloudinary media — signed profile + unsigned chat
// //
// // PROFILE IMAGES → Signed upload (edge fn generates SHA-1 signature)
// //   ✅ overwrite=true allowed (signed)
// //   ✅ One file per user — public_id = mindmates/profiles/profile_{userId}
// //   ✅ Same CDN URL persists (only version number changes on overwrite)
// //   ✅ Works on Android + iOS + Web
// //
// // CHAT MEDIA → Unsigned upload (direct, no signature needed)
// //   ✅ Auto-generated ID, never overwritten
// //
// // CRITICAL FIXES IN SIGNED UPLOAD:
// //   FormData must contain EXACTLY: public_id, overwrite, timestamp, signature, api_key, file
// //   NO upload_preset (signed uploads don't use presets)
// //   NO folder (full path is in public_id already)
// //   The signature was SHA-256 before — fixed to SHA-1 (Cloudinary default)
...
// export const cdnVideoThumbUrl = (url: string): string =>
//   url.replace('/video/upload/', '/video/upload/so_0,w_400,h_300,c_fill,f_jpg/')
...
//     .replace('/video/upload/', '/video/upload/f_auto,q_auto:good/');
// };
