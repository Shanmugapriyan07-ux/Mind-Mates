...
const OPEN_CONFIG  = { duration: 220, useNativeDriver: true } as const;
const CLOSE_CONFIG = { duration: 160, useNativeDriver: true } as const;
...
// ═══════════════════════════════════════════════════════════════
// USAGE EXAMPLES  (copy-paste into your screen files)
// ═══════════════════════════════════════════════════════════════
...
<ConfirmModal
  visible={clearModal}
  title="Clear Chat?"
  message="This will remove all messages from your view only. Your contact won't be affected."
  confirmLabel="Clear"
  icon="trash-outline"
  onConfirm={() => {
    setClearModal(false);
    handleClearChat(); // your existing handler
  }}
  onCancel={() => setClearModal(false)}
/>

// ── 2. Delete Chat (hide chat) ───────────────────────────────
const [deleteModal, setDeleteModal] = useState(false);

<ConfirmModal
  visible={deleteModal}
  title="Delete Chat?"
  message="This conversation will be removed from your list. You can still message them again."
  confirmLabel="Delete"
  icon="chatbubble-ellipses-outline"
  onConfirm={() => {
    setDeleteModal(false);
    handleDelete(friend); // your existing handler
  }}
...
// ── 4. Logout (matches your screenshot icon style) ───────────
<ConfirmModal
  visible={logoutModal}
  title="Logout"
  message="Are you sure you want to logout?"
  confirmLabel="Logout"
  confirmDestructive={false}     // purple confirm instead of red
