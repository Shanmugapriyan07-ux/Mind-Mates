...
const s = StyleSheet.create({
  ...
  searchRow:  { flexDirection:'row', alignItems:'center', paddingHorizontal:12, marginBottom:4, gap:8 },
  searchBar:  {
    flex:1, flexDirection:'row', alignItems:'center', gap:7,
    backgroundColor:C.bg, borderRadius:50, paddingHorizontal:15,
    height:43,
    marginLeft:17, marginRight:18, marginBottom:10,top:7,
  },
  ...
  tabsScroll:  { paddingHorizontal:16,paddingBottom:10, paddingTop:2, gap:8, flexDirection:'row',alignItems:'center', justifyContent:'center',width:'100%',},
  tab:         {
