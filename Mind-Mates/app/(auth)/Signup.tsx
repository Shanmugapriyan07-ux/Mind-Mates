...
// app/(auth)/Signup.tsx — Supabase version
// FIXES:
//   register() uses Supabase signUp ✅
//   Handles CHECK_EMAIL case (email confirm ON) ✅
//   Double-submit guard ✅
//   After signup → _layout routes to BasicInfo automatically ✅
