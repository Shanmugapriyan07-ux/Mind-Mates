    ...
    <Pressable style={sh.backdrop} onPress={onClose}>
      <Pressable style={sh.card} onPress={() => {}}>
        ...
        <TouchableOpacity style={sh.row}
          ...
          activeOpacity={0.7}>
          <Ionicons name="person-outline" size={20} color={C.text} style={{left:5}} />
        ...
        <TouchableOpacity style={sh.row}
          ...
          activeOpacity={0.7}>
          <Ionicons name="trash-outline" size={20} color={C.red} style={{left:5}} />
          <Text style={[sh.rowText, { color: C.red }]}>Delete Notification</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[sh.row, sh.cancelRow]} onPress={onClose}>
...
const sh = StyleSheet.create({
  ...
  rowText:   { fontSize: 16, fontWeight: '500', color: C.text, marginLeft: 14, left:5 },
  ...
  return (
    ...
    >
      ...
      <TouchableOpacity style={bk.deleteBtn} onPress={onDeleteAll} activeOpacity={0.85}>
        <Ionicons name="trash" size={15} color={'#ff4a4a'} />
...
const bk = StyleSheet.create({
  ...
  deleteBtn:  { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: 'rgb(255, 245, 245)', paddingHorizontal: 14, paddingVertical: 8, borderRadius: 8 },
  deleteTxt:  { color: '#ff4a4a', fontWeight: '700', fontSize: 13 },
});
