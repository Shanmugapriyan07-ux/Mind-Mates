...
const st = StyleSheet.create({
  ...
  searchWrap:      { flexDirection: 'row', alignItems: 'center', backgroundColor: '#F7F8FA', borderRadius: 50, paddingHorizontal: 16, marginBottom: 14, marginTop: 15, elevation: 1 },
  ...
  cardInner:       { backgroundColor: '#fff', borderRadius: 20, padding: 10, paddingTop: 16, minHeight: 128 },
  card:            { borderRadius: 20, padding: 20, paddingTop: 12, minHeight: 128, position: 'relative' },
