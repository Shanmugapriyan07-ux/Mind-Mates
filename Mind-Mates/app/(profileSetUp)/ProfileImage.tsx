  ...
  return (
    <View style={s.container}>
      ...
      <View style={s.buttons}>
        <TouchableOpacity onPress={() => router.replace('/(profileSetUp)/BasicInfo')} style={s.backBtn}>
          <Text style={s.backText}>Back</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={handleNext} style={s.nextOuter}>
          <LinearGradient colors={['#7C3AED', '#800bf5']} start={{x:0,y:0}} end={{x:1,y:0}} style={s.next}>
...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 15, color: '#494a4c', marginBottom: 40 },
  ...
  next: { paddingVertical: 16, alignItems: 'center' },
