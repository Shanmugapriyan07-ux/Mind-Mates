// // hooks/useMatches.ts
// // ✅ NO EDGE FUNCTION — queries Supabase DB directly
// // ✅ Client-side ranking (Instagram strategy for small-medium datasets)
// // ✅ Web-safe cache (localStorage on web, AsyncStorage on native)
// // ✅ Cache-first → instant display → background refresh
// // ✅ Zero CORS issues
